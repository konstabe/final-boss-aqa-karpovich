...
test.describe("[API] [Sales Portal] [Customers]", () => {
	...
	test.describe("[Positive]", () => {
		...
		test("Create a customer with minimal required fields", async ({ customersApi }) => {
	...
	test.describe("[Negative]", () => {
		...
		for (const field of requiredFields) {
			test(`Create a customer with empty required field ${field}`, async ({ customersApi }) => {
		...
		test("Create a customer with invalid token", async ({ customersApi }) => {
			const customerData = generateCustomerData();
		...
		test("Create a customer with an email that already exists", async ({ customersApi, customersApiService }) => {
